...
scheduler.attachEvent("onTemplatesReady", function() {
	...
	scheduler.attachEvent("onBeforeLightbox", function(id) {
		if (this.config.readonly_form || (typeof this.getEvent(id).readonly =='string' && this.getEvent(id).readonly==1) ) {
	...
	function txt_replace(tag, d, n, text) {
		if(tag == 'option')
		{
			var txts = d.getElementsByTagName("LI");
			var txtt = d.getElementsByTagName("LI");			
		}else{
	...
	scheduler._fill_lightbox = function() {
		...
		if (this.config.readonly_active) {
			...
			txt_replace("cite", d, n, function(a) {
				return '';
			});
			
			txt_replace("option", d, n, function(a) {
				return '';
			});
