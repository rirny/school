<?php
$path = APPLICATION_PATH."/application/library/Smarty/sysplugins/";
require_once "Smarty.class.php";
//include_once $path."smarty_internal_smartytemplatecompiler.php";
include_once $path."smarty_internal_templatecompilerbase.php";
include_once $path."smarty_internal_templatelexer.php";
include_once $path."smarty_internal_templateparser.php";
include_once $path."smarty_internal_write_file.php";
include_once $path."smarty_internal_debug.php";
include_once $path."smarty_internal_compilebase.php";
include_once $path."smarty_internal_config.php";
include_once $path."smarty_internal_config_file_compiler.php";
include_once $path."smarty_internal_configfilelexer.php";
include_once $path."smarty_internal_configfileparser.php";
include_once $path."smarty_config_source.php";
